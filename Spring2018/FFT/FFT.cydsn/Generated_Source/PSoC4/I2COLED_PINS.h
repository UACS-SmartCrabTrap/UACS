...
***************************************/
    ...
    #define I2COLED_RX_SCL_MOSI_HSIOM_SEL_GPIO  (I2COLED_uart_rx_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define I2COLED_RX_SCL_MOSI_HSIOM_SEL_I2C   (I2COLED_uart_rx_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define I2COLED_RX_SCL_MOSI_HSIOM_SEL_SPI   (I2COLED_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define I2COLED_RX_SCL_MOSI_HSIOM_SEL_UART  (I2COLED_uart_rx_i2c_scl_spi_mosi__0__HSIOM_UART)
    
#elif (I2COLED_RX_WAKE_SCL_MOSI_PIN)
    #define I2COLED_RX_WAKE_SCL_MOSI_HSIOM_REG   (*(reg32 *) I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define I2COLED_RX_WAKE_SCL_MOSI_HSIOM_PTR   ( (reg32 *) I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    
    #define I2COLED_RX_WAKE_SCL_MOSI_HSIOM_MASK      (I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define I2COLED_RX_WAKE_SCL_MOSI_HSIOM_POS       (I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
    #define I2COLED_RX_WAKE_SCL_MOSI_HSIOM_SEL_GPIO  (I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define I2COLED_RX_WAKE_SCL_MOSI_HSIOM_SEL_I2C   (I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define I2COLED_RX_WAKE_SCL_MOSI_HSIOM_SEL_SPI   (I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define I2COLED_RX_WAKE_SCL_MOSI_HSIOM_SEL_UART  (I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_UART)    
   
    #define I2COLED_RX_WAKE_SCL_MOSI_INTCFG_REG (*(reg32 *) I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define I2COLED_RX_WAKE_SCL_MOSI_INTCFG_PTR ( (reg32 *) I2COLED_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define I2COLED_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (I2COLED_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define I2COLED_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK ((uint32) I2COLED_INTCFG_TYPE_MASK << \
                                                                           I2COLED_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins I2COLED_RX_SCL_MOSI_PIN or I2COLED_RX_WAKE_SCL_MOSI_PIN present.*/
    ...
    #define I2COLED_TX_SDA_MISO_HSIOM_SEL_GPIO  (I2COLED_uart_tx_i2c_sda_spi_miso__0__HSIOM_GPIO)
    #define I2COLED_TX_SDA_MISO_HSIOM_SEL_I2C   (I2COLED_uart_tx_i2c_sda_spi_miso__0__HSIOM_I2C)
    #define I2COLED_TX_SDA_MISO_HSIOM_SEL_SPI   (I2COLED_uart_tx_i2c_sda_spi_miso__0__HSIOM_SPI)
    #define I2COLED_TX_SDA_MISO_HSIOM_SEL_UART  (I2COLED_uart_tx_i2c_sda_spi_miso__0__HSIOM_UART)
    ...
    #define I2COLED_SCLK_HSIOM_SEL_GPIO  (I2COLED_spi_sclk__0__HSIOM_GPIO)
    #define I2COLED_SCLK_HSIOM_SEL_I2C   (I2COLED_spi_sclk__0__HSIOM_I2C)
    #define I2COLED_SCLK_HSIOM_SEL_SPI   (I2COLED_spi_sclk__0__HSIOM_SPI)
    #define I2COLED_SCLK_HSIOM_SEL_UART  (I2COLED_spi_sclk__0__HSIOM_UART)
    ...
    #define I2COLED_SS0_HSIOM_SEL_GPIO  (I2COLED_spi_ss0__0__HSIOM_GPIO)
    #define I2COLED_SS0_HSIOM_SEL_I2C   (I2COLED_spi_ss0__0__HSIOM_I2C)
    #define I2COLED_SS0_HSIOM_SEL_SPI   (I2COLED_spi_ss0__0__HSIOM_SPI)
#if !(I2COLED_CY_SCBIP_V0 || I2COLED_CY_SCBIP_V1)
    #define I2COLED_SS0_HSIOM_SEL_UART  (I2COLED_spi_ss0__0__HSIOM_UART)
    ...
    #define I2COLED_SS1_HSIOM_SEL_GPIO (I2COLED_spi_ss1__0__HSIOM_GPIO)
    #define I2COLED_SS1_HSIOM_SEL_I2C  (I2COLED_spi_ss1__0__HSIOM_I2C)
    #define I2COLED_SS1_HSIOM_SEL_SPI  (I2COLED_spi_ss1__0__HSIOM_SPI)
#endif /* (I2COLED_SS1_PIN) */
    ...
    #define I2COLED_SS2_HSIOM_SEL_GPIO (I2COLED_spi_ss2__0__HSIOM_GPIO)
    #define I2COLED_SS2_HSIOM_SEL_I2C  (I2COLED_spi_ss2__0__HSIOM_I2C)
    #define I2COLED_SS2_HSIOM_SEL_SPI  (I2COLED_spi_ss2__0__HSIOM_SPI)
#endif /* (I2COLED_SS2_PIN) */
    ...
    #define I2COLED_SS3_HSIOM_SEL_GPIO (I2COLED_spi_ss3__0__HSIOM_GPIO)
    #define I2COLED_SS3_HSIOM_SEL_I2C  (I2COLED_spi_ss3__0__HSIOM_I2C)
    #define I2COLED_SS3_HSIOM_SEL_SPI  (I2COLED_spi_ss3__0__HSIOM_SPI)
#endif /* (I2COLED_SS3_PIN) */
    ...
    #define I2COLED_SCL_HSIOM_SEL_GPIO (I2COLED_sda__0__HSIOM_GPIO)
    #define I2COLED_SCL_HSIOM_SEL_I2C  (I2COLED_sda__0__HSIOM_I2C)
    ...
    #define I2COLED_SDA_HSIOM_SEL_GPIO (I2COLED_sda__0__HSIOM_GPIO)
    #define I2COLED_SDA_HSIOM_SEL_I2C  (I2COLED_sda__0__HSIOM_I2C)
#endif /* (I2COLED_I2C_PINS) */

#if (I2COLED_SPI_SLAVE_PINS)
    #define I2COLED_SCLK_S_HSIOM_REG   (*(reg32 *) I2COLED_sclk_s__0__HSIOM)
    #define I2COLED_SCLK_S_HSIOM_PTR   ( (reg32 *) I2COLED_sclk_s__0__HSIOM)
    
    #define I2COLED_SCLK_S_HSIOM_MASK      (I2COLED_sclk_s__0__HSIOM_MASK)
    #define I2COLED_SCLK_S_HSIOM_POS       (I2COLED_sclk_s__0__HSIOM_SHIFT)
    #define I2COLED_SCLK_S_HSIOM_SEL_GPIO  (I2COLED_sclk_s__0__HSIOM_GPIO)
    #define I2COLED_SCLK_S_HSIOM_SEL_SPI   (I2COLED_sclk_s__0__HSIOM_SPI)
    
    #define I2COLED_SS0_S_HSIOM_REG    (*(reg32 *) I2COLED_ss0_s__0__HSIOM)
    #define I2COLED_SS0_S_HSIOM_PTR    ( (reg32 *) I2COLED_ss0_s__0__HSIOM)
    
    #define I2COLED_SS0_S_HSIOM_MASK       (I2COLED_ss0_s__0__HSIOM_MASK)
    #define I2COLED_SS0_S_HSIOM_POS        (I2COLED_ss0_s__0__HSIOM_SHIFT)
    #define I2COLED_SS0_S_HSIOM_SEL_GPIO   (I2COLED_ss0_s__0__HSIOM_GPIO)  
    #define I2COLED_SS0_S_HSIOM_SEL_SPI    (I2COLED_ss0_s__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_SLAVE_PINS) */

#if (I2COLED_SPI_SLAVE_MOSI_PIN)
    #define I2COLED_MOSI_S_HSIOM_REG   (*(reg32 *) I2COLED_mosi_s__0__HSIOM)
    #define I2COLED_MOSI_S_HSIOM_PTR   ( (reg32 *) I2COLED_mosi_s__0__HSIOM)
    
    #define I2COLED_MOSI_S_HSIOM_MASK      (I2COLED_mosi_s__0__HSIOM_MASK)
    #define I2COLED_MOSI_S_HSIOM_POS       (I2COLED_mosi_s__0__HSIOM_SHIFT)
    #define I2COLED_MOSI_S_HSIOM_SEL_GPIO  (I2COLED_mosi_s__0__HSIOM_GPIO)
    #define I2COLED_MOSI_S_HSIOM_SEL_SPI   (I2COLED_mosi_s__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_SLAVE_MOSI_PIN) */

#if (I2COLED_SPI_SLAVE_MISO_PIN)
    #define I2COLED_MISO_S_HSIOM_REG   (*(reg32 *) I2COLED_miso_s__0__HSIOM)
    #define I2COLED_MISO_S_HSIOM_PTR   ( (reg32 *) I2COLED_miso_s__0__HSIOM)
    
    #define I2COLED_MISO_S_HSIOM_MASK      (I2COLED_miso_s__0__HSIOM_MASK)
    #define I2COLED_MISO_S_HSIOM_POS       (I2COLED_miso_s__0__HSIOM_SHIFT)
    #define I2COLED_MISO_S_HSIOM_SEL_GPIO  (I2COLED_miso_s__0__HSIOM_GPIO)
    #define I2COLED_MISO_S_HSIOM_SEL_SPI   (I2COLED_miso_s__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_SLAVE_MISO_PIN) */

#if (I2COLED_SPI_MASTER_MISO_PIN)
    #define I2COLED_MISO_M_HSIOM_REG   (*(reg32 *) I2COLED_miso_m__0__HSIOM)
    #define I2COLED_MISO_M_HSIOM_PTR   ( (reg32 *) I2COLED_miso_m__0__HSIOM)
    
    #define I2COLED_MISO_M_HSIOM_MASK      (I2COLED_miso_m__0__HSIOM_MASK)
    #define I2COLED_MISO_M_HSIOM_POS       (I2COLED_miso_m__0__HSIOM_SHIFT)
    #define I2COLED_MISO_M_HSIOM_SEL_GPIO  (I2COLED_miso_m__0__HSIOM_GPIO)
    #define I2COLED_MISO_M_HSIOM_SEL_SPI   (I2COLED_miso_m__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_MASTER_MISO_PIN) */

#if (I2COLED_SPI_MASTER_MOSI_PIN)
    #define I2COLED_MOSI_M_HSIOM_REG   (*(reg32 *) I2COLED_mosi_m__0__HSIOM)
    #define I2COLED_MOSI_M_HSIOM_PTR   ( (reg32 *) I2COLED_mosi_m__0__HSIOM)
    
    #define I2COLED_MOSI_M_HSIOM_MASK      (I2COLED_mosi_m__0__HSIOM_MASK)
    #define I2COLED_MOSI_M_HSIOM_POS       (I2COLED_mosi_m__0__HSIOM_SHIFT)
    #define I2COLED_MOSI_M_HSIOM_SEL_GPIO  (I2COLED_mosi_m__0__HSIOM_GPIO)
    #define I2COLED_MOSI_M_HSIOM_SEL_SPI   (I2COLED_mosi_m__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_MASTER_MOSI_PIN) */
    ...
    #define I2COLED_SCLK_M_HSIOM_SEL_GPIO  (I2COLED_sclk_m__0__HSIOM_GPIO)
    #define I2COLED_SCLK_M_HSIOM_SEL_SPI   (I2COLED_sclk_m__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_MASTER_SCLK_PIN) */
    ...
    #define I2COLED_SS0_M_HSIOM_SEL_GPIO   (I2COLED_ss0_m__0__HSIOM_GPIO)
    #define I2COLED_SS0_M_HSIOM_SEL_SPI    (I2COLED_ss0_m__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_MASTER_SS0_PIN) */
    ...
    #define I2COLED_SS1_M_HSIOM_SEL_GPIO   (I2COLED_ss1_m__0__HSIOM_GPIO)
    #define I2COLED_SS1_M_HSIOM_SEL_SPI    (I2COLED_ss1_m__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_MASTER_SS1_PIN) */
    ...
    #define I2COLED_SS2_M_HSIOM_SEL_GPIO   (I2COLED_ss2_m__0__HSIOM_GPIO)
    #define I2COLED_SS2_M_HSIOM_SEL_SPI    (I2COLED_ss2_m__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_MASTER_SS2_PIN) */
    ...
    #define I2COLED_SS3_M_HSIOM_SEL_GPIO  (I2COLED_ss3_m__0__HSIOM_GPIO)
    #define I2COLED_SS3_M_HSIOM_SEL_SPI   (I2COLED_ss3_m__0__HSIOM_SPI)
#endif /* (I2COLED_SPI_MASTER_SS3_PIN) */

#if (I2COLED_UART_RX_PIN)
    #define I2COLED_RX_HSIOM_REG   (*(reg32 *) I2COLED_rx__0__HSIOM)
    #define I2COLED_RX_HSIOM_PTR   ( (reg32 *) I2COLED_rx__0__HSIOM)
    
    #define I2COLED_RX_HSIOM_MASK      (I2COLED_rx__0__HSIOM_MASK)
    #define I2COLED_RX_HSIOM_POS       (I2COLED_rx__0__HSIOM_SHIFT)
    #define I2COLED_RX_HSIOM_SEL_GPIO  (I2COLED_rx__0__HSIOM_GPIO)
    #define I2COLED_RX_HSIOM_SEL_UART  (I2COLED_rx__0__HSIOM_UART)
#endif /* (I2COLED_UART_RX_PIN) */

#if (I2COLED_UART_RX_WAKE_PIN)
    #define I2COLED_RX_WAKE_HSIOM_REG   (*(reg32 *) I2COLED_rx_wake__0__HSIOM)
    #define I2COLED_RX_WAKE_HSIOM_PTR   ( (reg32 *) I2COLED_rx_wake__0__HSIOM)
    
    #define I2COLED_RX_WAKE_HSIOM_MASK      (I2COLED_rx_wake__0__HSIOM_MASK)
    #define I2COLED_RX_WAKE_HSIOM_POS       (I2COLED_rx_wake__0__HSIOM_SHIFT)
    #define I2COLED_RX_WAKE_HSIOM_SEL_GPIO  (I2COLED_rx_wake__0__HSIOM_GPIO)
    #define I2COLED_RX_WAKE_HSIOM_SEL_UART  (I2COLED_rx_wake__0__HSIOM_UART)
#endif /* (I2COLED_UART_WAKE_RX_PIN) */

#if (I2COLED_UART_CTS_PIN)
    #define I2COLED_CTS_HSIOM_REG   (*(reg32 *) I2COLED_cts__0__HSIOM)
    #define I2COLED_CTS_HSIOM_PTR   ( (reg32 *) I2COLED_cts__0__HSIOM)
    
    #define I2COLED_CTS_HSIOM_MASK      (I2COLED_cts__0__HSIOM_MASK)
    #define I2COLED_CTS_HSIOM_POS       (I2COLED_cts__0__HSIOM_SHIFT)
    #define I2COLED_CTS_HSIOM_SEL_GPIO  (I2COLED_cts__0__HSIOM_GPIO)
    #define I2COLED_CTS_HSIOM_SEL_UART  (I2COLED_cts__0__HSIOM_UART)
#endif /* (I2COLED_UART_CTS_PIN) */

#if (I2COLED_UART_TX_PIN)
    #define I2COLED_TX_HSIOM_REG   (*(reg32 *) I2COLED_tx__0__HSIOM)
    #define I2COLED_TX_HSIOM_PTR   ( (reg32 *) I2COLED_tx__0__HSIOM)
    
    #define I2COLED_TX_HSIOM_MASK      (I2COLED_tx__0__HSIOM_MASK)
    #define I2COLED_TX_HSIOM_POS       (I2COLED_tx__0__HSIOM_SHIFT)
    #define I2COLED_TX_HSIOM_SEL_GPIO  (I2COLED_tx__0__HSIOM_GPIO)
    #define I2COLED_TX_HSIOM_SEL_UART  (I2COLED_tx__0__HSIOM_UART)
#endif /* (I2COLED_UART_TX_PIN) */

#if (I2COLED_UART_RX_TX_PIN)
    #define I2COLED_RX_TX_HSIOM_REG   (*(reg32 *) I2COLED_rx_tx__0__HSIOM)
    #define I2COLED_RX_TX_HSIOM_PTR   ( (reg32 *) I2COLED_rx_tx__0__HSIOM)
    
    #define I2COLED_RX_TX_HSIOM_MASK      (I2COLED_rx_tx__0__HSIOM_MASK)
    #define I2COLED_RX_TX_HSIOM_POS       (I2COLED_rx_tx__0__HSIOM_SHIFT)
    #define I2COLED_RX_TX_HSIOM_SEL_GPIO  (I2COLED_rx_tx__0__HSIOM_GPIO)
    #define I2COLED_RX_TX_HSIOM_SEL_UART  (I2COLED_rx_tx__0__HSIOM_UART)
#endif /* (I2COLED_UART_RX_TX_PIN) */
    ...
    #define I2COLED_RTS_HSIOM_SEL_GPIO (I2COLED_rts__0__HSIOM_GPIO)
    #define I2COLED_RTS_HSIOM_SEL_UART (I2COLED_rts__0__HSIOM_UART)    
#endif /* (I2COLED_UART_RTS_PIN) */
...
/* The HSIOM values provided below are valid only for I2COLED_CY_SCBIP_V0 
* and I2COLED_CY_SCBIP_V1. It is not recommended to use them for 
* I2COLED_CY_SCBIP_V2. Use pin name specific HSIOM constants provided 
...
#if (I2COLED_SS0_PIN)
    #define I2COLED_CHECK_SS0_PIN_USED \
                (I2COLED_PIN_DM_ALG_HIZ != \
                    I2COLED_GET_P4_PIN_DM(I2COLED_spi_ss0_PC, \
                                                   I2COLED_spi_ss0_SHIFT))
#endif /* (I2COLED_SS0_PIN) */
...
#else
    #define I2COLED_SET_I2C_SCL_DR(val)        do{ /* Does nothing */ }while(0)
    #define I2COLED_SET_I2C_SCL_HSIOM_SEL(sel) do{ /* Does nothing */ }while(0)
...
#if (I2COLED_RX_SCL_MOSI_PIN)
    #define I2COLED_CLEAR_UART_RX_WAKE_INTR        do{ /* Does nothing */ }while(0)
    
#elif (I2COLED_RX_WAKE_SCL_MOSI_PIN)
    #define I2COLED_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) I2COLED_uart_rx_wake_i2c_scl_spi_mosi_ClearInterrupt(); \
            }while(0)

#elif(I2COLED_UART_RX_WAKE_PIN)
    #define I2COLED_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) I2COLED_rx_wake_ClearInterrupt(); \
            }while(0)
#else
#endif /* (I2COLED_RX_SCL_MOSI_PIN) */
...
#define I2COLED_REMOVE_SCLK_PIN                I2COLED_REMOVE_SCLK_PIN
#endif /* I2COLED_REMOVE_SCLK_PIN */
#ifndef I2COLED_REMOVE_SS0_PIN
#define I2COLED_REMOVE_SS0_PIN                 I2COLED_REMOVE_SS0_PIN
...
#define I2COLED_SCLK_PIN               I2COLED_SCLK_PIN
#endif /* I2COLED_SCLK_PIN */
#ifndef I2COLED_SS0_PIN
#define I2COLED_SS0_PIN                I2COLED_SS0_PIN
#endif /* I2COLED_SS0_PIN */
    ...
    #define I2COLED_SCLK_HSIOM_REG     I2COLED_SCLK_HSIOM_REG
    #define I2COLED_SCLK_HSIOM_PTR     I2COLED_SCLK_HSIOM_PTR
    #define I2COLED_SCLK_HSIOM_MASK    I2COLED_SCLK_HSIOM_MASK
    #define I2COLED_SCLK_HSIOM_POS     I2COLED_SCLK_HSIOM_POS
    #endif /* I2COLED_SCLK_HSIOM_REG */
#endif /* (I2COLED_SCLK_PIN) */

#if (I2COLED_SS0_PIN)
    #ifndef I2COLED_SS0_HSIOM_REG
    #define I2COLED_SS0_HSIOM_REG      I2COLED_SS0_HSIOM_REG
    #define I2COLED_SS0_HSIOM_PTR      I2COLED_SS0_HSIOM_PTR
    #define I2COLED_SS0_HSIOM_MASK     I2COLED_SS0_HSIOM_MASK
    #define I2COLED_SS0_HSIOM_POS      I2COLED_SS0_HSIOM_POS
...
#define I2COLED_SCLK_PIN_INDEX             I2COLED_SCLK_PIN_INDEX
#endif /* I2COLED_SCLK_PIN_INDEX */
#ifndef I2COLED_SS0_PIN_INDEX
#define I2COLED_SS0_PIN_INDEX              I2COLED_SS0_PIN_INDEX
...
#define I2COLED_SCLK_PIN_MASK             I2COLED_SCLK_PIN_MASK
#endif /* I2COLED_SCLK_PIN_MASK */
#ifndef I2COLED_SS0_PIN_MASK
#define I2COLED_SS0_PIN_MASK              I2COLED_SS0_PIN_MASK
