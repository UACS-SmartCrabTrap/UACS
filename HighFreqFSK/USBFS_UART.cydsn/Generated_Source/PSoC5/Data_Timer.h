...
#if !defined(CY_TIMER_Data_Timer_H)
#define CY_TIMER_Data_Timer_H
...
#define Data_Timer_Resolution                 32u
...
***************************************/
    ...
    ***************************************/
    ...
    #define Data_Timer_CONTROL             (* (reg8 *) Data_Timer_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG )
        ...
        #define Data_Timer_CAPTURE_LSB         (* (reg8 *) Data_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Data_Timer_CAPTURE_LSB_PTR       ((reg8 *) Data_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Data_Timer_PERIOD_LSB          (* (reg8 *) Data_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Data_Timer_PERIOD_LSB_PTR        ((reg8 *) Data_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Data_Timer_COUNTER_LSB         (* (reg8 *) Data_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define Data_Timer_COUNTER_LSB_PTR       ((reg8 *) Data_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
    #elif(Data_Timer_Resolution <= 16u) /* 8-bit Timer */
        #if(CY_PSOC3) /* 8-bit addres space */
            #define Data_Timer_CAPTURE_LSB         (* (reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define Data_Timer_CAPTURE_LSB_PTR       ((reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
            #define Data_Timer_PERIOD_LSB          (* (reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define Data_Timer_PERIOD_LSB_PTR        ((reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
            #define Data_Timer_COUNTER_LSB         (* (reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
            #define Data_Timer_COUNTER_LSB_PTR       ((reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #else /* 16-bit address space */
            #define Data_Timer_CAPTURE_LSB         (* (reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define Data_Timer_CAPTURE_LSB_PTR       ((reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__16BIT_F0_REG )
            #define Data_Timer_PERIOD_LSB          (* (reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define Data_Timer_PERIOD_LSB_PTR        ((reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__16BIT_D0_REG )
            #define Data_Timer_COUNTER_LSB         (* (reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
            #define Data_Timer_COUNTER_LSB_PTR       ((reg16 *) Data_Timer_TimerUDB_sT32_timerdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */
    #elif(Data_Timer_Resolution <= 24u)/* 24-bit Timer */
        #define Data_Timer_CAPTURE_LSB         (* (reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Data_Timer_CAPTURE_LSB_PTR       ((reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__F0_REG )
        #define Data_Timer_PERIOD_LSB          (* (reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Data_Timer_PERIOD_LSB_PTR        ((reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__D0_REG )
        #define Data_Timer_COUNTER_LSB         (* (reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
        #define Data_Timer_COUNTER_LSB_PTR       ((reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
    #else /* 32-bit Timer */
            ...
            #define Data_Timer_CAPTURE_LSB         (* (reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define Data_Timer_CAPTURE_LSB_PTR       ((reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__32BIT_F0_REG )
            #define Data_Timer_PERIOD_LSB          (* (reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define Data_Timer_PERIOD_LSB_PTR        ((reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__32BIT_D0_REG )
            #define Data_Timer_COUNTER_LSB         (* (reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
            #define Data_Timer_COUNTER_LSB_PTR       ((reg32 *) Data_Timer_TimerUDB_sT32_timerdp_u0__32BIT_A0_REG )
        #endif /* CY_PSOC3 || CY_PSOC5 */ 
    #endif

    #define Data_Timer_COUNTER_LSB_PTR_8BIT       ((reg8 *) Data_Timer_TimerUDB_sT32_timerdp_u0__A0_REG )
