...
void CRC_Wakeup(void) ;
    ...
    uint8 CRC_ReadCRC(void) ;
    void CRC_WriteSeed(uint8 seed)  ;
    uint8 CRC_ReadPolynomial(void)
                                               ;
    void CRC_WritePolynomial(uint8 polynomial)
                                          ;
...
#if (CRC_CRC_SIZE <= 32u) /* 8-32 bits CRC */
    void CRC_ResetSeedInit(uint8 seed)
                                        ;
#else
...
#if (CRC_CRC_SIZE <= 32u)
    #define CRC_DEFAULT_POLYNOM            (0x9u)
    #define CRC_DEFAULT_SEED               (0x0u)

#else
    #define CRC_DEFAULT_POLYNOM_UPPER      (0x0u)
    #define CRC_DEFAULT_POLYNOM_LOWER      (0x9u)
...
#define CRC_EXECUTE_DFF_RESET    { CRC_CONTROL_REG |= CRC_CTRL_RESET; \
    CRC_CONTROL_REG &= (uint8)~CRC_CTRL_RESET; }
        ...
        #define CRC_SEED_LOWER_COPY_A__A0_PTR          ( (reg8 *) CRC_b0_CRCdp_a__F0_REG )
        ...
        #if (CRC_CRC_SIZE <= 32u)         /* 8-32 bits CRC */
            /* Polynomial */
            #define CRC_POLYNOM_PTR      ( (reg8 *)\
                                                CRC_sC8_CRCdp_u0__D0_REG )
            /* Seed */
            #define CRC_SEED_PTR         ( (reg8 *)\
                                                CRC_sC8_CRCdp_u0__A0_REG )
            /* Seed COPY */
            #define CRC_SEED_COPY_PTR    ( (reg8 *)\
                                                CRC_sC8_CRCdp_u0__F0_REG )
            ...
            /* Polynomial */
            #define CRC_POLYNOM_PTR      ( (reg8 *)\
                                            CRC_sC8_CRCdp_u0__16BIT_D0_REG )
            /* Seed */
            #define CRC_SEED_PTR         ( (reg8 *)\
                                            CRC_sC8_CRCdp_u0__16BIT_A0_REG )
            /* Seed COPY */
            #define CRC_SEED_COPY_PTR    ( (reg8 *)\
                                            CRC_sC8_CRCdp_u0__16BIT_F0_REG )
            ...
            /* Polynomial */
            #define CRC_POLYNOM_PTR      ( (reg8 *)\
                                            CRC_sC8_CRCdp_u0__32BIT_D0_REG )
            /* Seed */
            #define CRC_SEED_PTR         ( (reg8 *)\
                                            CRC_sC8_CRCdp_u0__32BIT_A0_REG )
            /* Seed COPY */
            #define CRC_SEED_COPY_PTR    ( (reg8 *)\
                                            CRC_sC8_CRCdp_u0__32BIT_F0_REG )
