...
module top ;
    ...
    defparam checkWatchDogTimer.Resolution = 32;
    ...
    UART_v2_50_6 UART (
        ...
        .reset(1'b0),
        .rx(Net_298),
        .tx_interrupt(Net_299),
        .rx_interrupt(Net_300),
        .tx_data(Net_301),
        .tx_clk(Net_302),
        .rx_data(Net_303),
        .rx_clk(Net_304));
