    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        enableInterrupts = CyEnterCriticalSection();
            ...
            /* Write Seed COPY */
            CY_SET_REG8(CRC_SEED_COPY_PTR, seed);
    ...
    *******************************************************************************/
    uint8 CRC_ReadCRC(void) 
    {
        /* Read CRC */
            ...
            #if((0u != (CRC_CRC_SIZE % 8u)) || (CRC_CRC_SIZE == 24u))
                return (CY_GET_REG8(CRC_SEED_PTR)  & CRC_MASK);
            #else
                return (CY_GET_REG8(CRC_SEED_PTR));
            #endif /* ((0u != (CRC_CRC_SIZE % 8u)) || (CRC_CRC_SIZE == 24u)) */
    ...
    *******************************************************************************/
                                               ...
                                               
    {
        /* Reads polynomial */
            ...
            return CY_GET_REG8(CRC_POLYNOM_PTR);
    ...
    *******************************************************************************/
                                          ...
                                          
    {
        ...
        /* Write polynomial */
            ...
            CY_SET_REG8(CRC_POLYNOM_PTR, polynomial);
