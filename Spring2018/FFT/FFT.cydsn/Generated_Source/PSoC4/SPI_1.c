...
static void SPI_1_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void SPI_1_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        else if (SPI_1_SCB_MODE_SPI == mode)
        {
        ...
        #if (SPI_1_SCLK_PIN)
            hsiomSel[SPI_1_SCLK_PIN_INDEX] = SPI_1_SCLK_HSIOM_SEL_SPI;
            ...
            if (SPI_1_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[SPI_1_SS0_PIN_INDEX] = SPI_1_SS0_HSIOM_SEL_SPI;
        ...
        else /* UART */
        {
            ...
            else /* Standard or IrDA */
            {
                ...
                if (SPI_1_UART_MODE_STD == subMode)
                {
                    ...
                    #if (SPI_1_SCLK_PIN)
                        hsiomSel[SPI_1_SCLK_PIN_INDEX] = SPI_1_SCLK_HSIOM_SEL_UART;
                        pinsDm  [SPI_1_SCLK_PIN_INDEX] = SPI_1_PIN_DM_DIG_HIZ;
                    #endif /* (SPI_1_SCLK_PIN) */
                    }
                    ...
                    #if (SPI_1_SS0_PIN)
                        hsiomSel[SPI_1_SS0_PIN_INDEX] = SPI_1_SS0_HSIOM_SEL_UART;
                        pinsDm  [SPI_1_SS0_PIN_INDEX] = SPI_1_PIN_DM_STRONG;
    ...
    #if (SPI_1_SCLK_PIN)
        SPI_1_SET_HSIOM_SEL(SPI_1_SCLK_HSIOM_REG,
                                       SPI_1_SCLK_HSIOM_MASK,
                                       SPI_1_SCLK_HSIOM_POS,
                                       hsiomSel[SPI_1_SCLK_PIN_INDEX]);
    ...
    #if (SPI_1_SS0_PIN)
        SPI_1_SET_HSIOM_SEL(SPI_1_SS0_HSIOM_REG,
                                       SPI_1_SS0_HSIOM_MASK,
                                       SPI_1_SS0_HSIOM_POS,
                                       hsiomSel[SPI_1_SS0_PIN_INDEX]);
