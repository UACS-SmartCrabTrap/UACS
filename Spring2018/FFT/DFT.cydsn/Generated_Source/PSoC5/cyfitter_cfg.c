...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x480000B4u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480000C4u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT1_AMUX, 0x2040u);
