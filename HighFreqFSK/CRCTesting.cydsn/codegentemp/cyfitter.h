...
/* CRC */
#define CRC_sC8_CRCdp_u0__16BIT_A0_REG CYREG_B0_UDB02_03_A0
#define CRC_sC8_CRCdp_u0__16BIT_A1_REG CYREG_B0_UDB02_03_A1
#define CRC_sC8_CRCdp_u0__16BIT_D0_REG CYREG_B0_UDB02_03_D0
#define CRC_sC8_CRCdp_u0__16BIT_D1_REG CYREG_B0_UDB02_03_D1
#define CRC_sC8_CRCdp_u0__16BIT_DP_AUX_CTL_REG CYREG_B0_UDB02_03_ACTL
#define CRC_sC8_CRCdp_u0__16BIT_F0_REG CYREG_B0_UDB02_03_F0
#define CRC_sC8_CRCdp_u0__16BIT_F1_REG CYREG_B0_UDB02_03_F1
#define CRC_sC8_CRCdp_u0__A0_A1_REG CYREG_B0_UDB02_A0_A1
#define CRC_sC8_CRCdp_u0__A0_REG CYREG_B0_UDB02_A0
#define CRC_sC8_CRCdp_u0__A1_REG CYREG_B0_UDB02_A1
#define CRC_sC8_CRCdp_u0__D0_D1_REG CYREG_B0_UDB02_D0_D1
#define CRC_sC8_CRCdp_u0__D0_REG CYREG_B0_UDB02_D0
#define CRC_sC8_CRCdp_u0__D1_REG CYREG_B0_UDB02_D1
#define CRC_sC8_CRCdp_u0__DP_AUX_CTL_REG CYREG_B0_UDB02_ACTL
#define CRC_sC8_CRCdp_u0__F0_F1_REG CYREG_B0_UDB02_F0_F1
#define CRC_sC8_CRCdp_u0__F0_REG CYREG_B0_UDB02_F0
#define CRC_sC8_CRCdp_u0__F1_REG CYREG_B0_UDB02_F1
#define CRC_sC8_CRCdp_u0__MSK_DP_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define CRC_sC8_CRCdp_u0__PER_DP_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define CRC_SyncCtrl_CtrlReg__0__MASK 0x01u
#define CRC_SyncCtrl_CtrlReg__0__POS 0
#define CRC_SyncCtrl_CtrlReg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB02_03_ACTL
#define CRC_SyncCtrl_CtrlReg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB02_03_CTL
#define CRC_SyncCtrl_CtrlReg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB02_03_CTL
#define CRC_SyncCtrl_CtrlReg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB02_03_CTL
#define CRC_SyncCtrl_CtrlReg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB02_03_CTL
#define CRC_SyncCtrl_CtrlReg__16BIT_MASK_MASK_REG CYREG_B0_UDB02_03_MSK
#define CRC_SyncCtrl_CtrlReg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB02_03_MSK
#define CRC_SyncCtrl_CtrlReg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB02_03_MSK
#define CRC_SyncCtrl_CtrlReg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB02_03_MSK
#define CRC_SyncCtrl_CtrlReg__CONTROL_AUX_CTL_REG CYREG_B0_UDB02_ACTL
#define CRC_SyncCtrl_CtrlReg__CONTROL_REG CYREG_B0_UDB02_CTL
#define CRC_SyncCtrl_CtrlReg__CONTROL_ST_REG CYREG_B0_UDB02_ST_CTL
#define CRC_SyncCtrl_CtrlReg__COUNT_REG CYREG_B0_UDB02_CTL
#define CRC_SyncCtrl_CtrlReg__COUNT_ST_REG CYREG_B0_UDB02_ST_CTL
#define CRC_SyncCtrl_CtrlReg__MASK 0x01u
#define CRC_SyncCtrl_CtrlReg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define CRC_SyncCtrl_CtrlReg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB02_MSK_ACTL
#define CRC_SyncCtrl_CtrlReg__PERIOD_REG CYREG_B0_UDB02_MSK
...
/* bitStream */
#define bitStream__0__INTTYPE CYREG_PICU0_INTTYPE1
#define bitStream__0__MASK 0x02u
#define bitStream__0__PC CYREG_PRT0_PC1
#define bitStream__0__PORT 0u
#define bitStream__0__SHIFT 1u
#define bitStream__AG CYREG_PRT0_AG
#define bitStream__AMUX CYREG_PRT0_AMUX
#define bitStream__BIE CYREG_PRT0_BIE
#define bitStream__BIT_MASK CYREG_PRT0_BIT_MASK
#define bitStream__BYP CYREG_PRT0_BYP
#define bitStream__CTL CYREG_PRT0_CTL
#define bitStream__DM0 CYREG_PRT0_DM0
#define bitStream__DM1 CYREG_PRT0_DM1
#define bitStream__DM2 CYREG_PRT0_DM2
#define bitStream__DR CYREG_PRT0_DR
#define bitStream__INP_DIS CYREG_PRT0_INP_DIS
#define bitStream__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define bitStream__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define bitStream__LCD_EN CYREG_PRT0_LCD_EN
#define bitStream__MASK 0x02u
#define bitStream__PORT 0u
#define bitStream__PRT CYREG_PRT0_PRT
#define bitStream__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define bitStream__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define bitStream__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define bitStream__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define bitStream__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define bitStream__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define bitStream__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define bitStream__PS CYREG_PRT0_PS
#define bitStream__SHIFT 1u
#define bitStream__SLW CYREG_PRT0_SLW

/* changeBitStream */
#define changeBitStream__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define changeBitStream__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define changeBitStream__INTC_MASK 0x01u
#define changeBitStream__INTC_NUMBER 0u
#define changeBitStream__INTC_PRIOR_NUM 7u
#define changeBitStream__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define changeBitStream__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define changeBitStream__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "CRCTesting"
