...
void HighF_ShiftReg_SaveConfig(void) 
{
    ...
    HighF_ShiftReg_backup.saveSrA0Reg   = CY_GET_REG32(HighF_ShiftReg_SHIFT_REG_LSB_PTR);
    HighF_ShiftReg_backup.saveSrA1Reg   = CY_GET_REG32(HighF_ShiftReg_SHIFT_REG_VALUE_LSB_PTR);
...
void HighF_ShiftReg_RestoreConfig(void) 
{
    ...
    CY_SET_REG32(HighF_ShiftReg_SHIFT_REG_LSB_PTR, HighF_ShiftReg_backup.saveSrA0Reg);
    CY_SET_REG32(HighF_ShiftReg_SHIFT_REG_VALUE_LSB_PTR, HighF_ShiftReg_backup.saveSrA1Reg);
