...
***************************************/
    ...
    #define SPI_1_SCLK_HSIOM_SEL_GPIO  (SPI_1_spi_sclk__0__HSIOM_GPIO)
    #define SPI_1_SCLK_HSIOM_SEL_I2C   (SPI_1_spi_sclk__0__HSIOM_I2C)
    #define SPI_1_SCLK_HSIOM_SEL_SPI   (SPI_1_spi_sclk__0__HSIOM_SPI)
    #define SPI_1_SCLK_HSIOM_SEL_UART  (SPI_1_spi_sclk__0__HSIOM_UART)
    ...
    #define SPI_1_SS0_HSIOM_SEL_GPIO  (SPI_1_spi_ss0__0__HSIOM_GPIO)
    #define SPI_1_SS0_HSIOM_SEL_I2C   (SPI_1_spi_ss0__0__HSIOM_I2C)
    #define SPI_1_SS0_HSIOM_SEL_SPI   (SPI_1_spi_ss0__0__HSIOM_SPI)
#if !(SPI_1_CY_SCBIP_V0 || SPI_1_CY_SCBIP_V1)
    #define SPI_1_SS0_HSIOM_SEL_UART  (SPI_1_spi_ss0__0__HSIOM_UART)
...
#if (SPI_1_SS0_PIN)
    #define SPI_1_CHECK_SS0_PIN_USED \
                (SPI_1_PIN_DM_ALG_HIZ != \
                    SPI_1_GET_P4_PIN_DM(SPI_1_spi_ss0_PC, \
                                                   SPI_1_spi_ss0_SHIFT))
#endif /* (SPI_1_SS0_PIN) */
...
#define SPI_1_REMOVE_SCLK_PIN                SPI_1_REMOVE_SCLK_PIN
#endif /* SPI_1_REMOVE_SCLK_PIN */
#ifndef SPI_1_REMOVE_SS0_PIN
#define SPI_1_REMOVE_SS0_PIN                 SPI_1_REMOVE_SS0_PIN
...
#define SPI_1_SCLK_PIN               SPI_1_SCLK_PIN
#endif /* SPI_1_SCLK_PIN */
#ifndef SPI_1_SS0_PIN
#define SPI_1_SS0_PIN                SPI_1_SS0_PIN
#endif /* SPI_1_SS0_PIN */
    ...
    #define SPI_1_SCLK_HSIOM_REG     SPI_1_SCLK_HSIOM_REG
    #define SPI_1_SCLK_HSIOM_PTR     SPI_1_SCLK_HSIOM_PTR
    #define SPI_1_SCLK_HSIOM_MASK    SPI_1_SCLK_HSIOM_MASK
    #define SPI_1_SCLK_HSIOM_POS     SPI_1_SCLK_HSIOM_POS
    #endif /* SPI_1_SCLK_HSIOM_REG */
#endif /* (SPI_1_SCLK_PIN) */

#if (SPI_1_SS0_PIN)
    #ifndef SPI_1_SS0_HSIOM_REG
    #define SPI_1_SS0_HSIOM_REG      SPI_1_SS0_HSIOM_REG
    #define SPI_1_SS0_HSIOM_PTR      SPI_1_SS0_HSIOM_PTR
    #define SPI_1_SS0_HSIOM_MASK     SPI_1_SS0_HSIOM_MASK
    #define SPI_1_SS0_HSIOM_POS      SPI_1_SS0_HSIOM_POS
...
#define SPI_1_SCLK_PIN_INDEX             SPI_1_SCLK_PIN_INDEX
#endif /* SPI_1_SCLK_PIN_INDEX */
#ifndef SPI_1_SS0_PIN_INDEX
#define SPI_1_SS0_PIN_INDEX              SPI_1_SS0_PIN_INDEX
...
#define SPI_1_SCLK_PIN_MASK             SPI_1_SCLK_PIN_MASK
#endif /* SPI_1_SCLK_PIN_MASK */
#ifndef SPI_1_SS0_PIN_MASK
#define SPI_1_SS0_PIN_MASK              SPI_1_SS0_PIN_MASK
