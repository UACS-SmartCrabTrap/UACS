...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ZeroPwm, CY_INSTANCE_SHORT_NAME=ZeroPwm, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=ZeroPwm, )
module PWM_v3_30_1 (
    reset,
    clock,
    tc,
...
module top ;
    ...
    PWM_v3_30_0 LowFPwm (
        ...
        .ph1(Net_388),
        .ph2(Net_389));
    defparam LowFPwm.Resolution = 16;
    ...
    PWM_v3_30_1 ZeroPwm (
        ...
        .ph1(Net_227),
        .ph2(Net_228));
    defparam ZeroPwm.Resolution = 16;
	...
	wire [0:0] tmpOE__muxSelect2_net;
	wire [0:0] tmpIO_0__muxSelect2_net;
	wire [0:0] tmpINTERRUPT_0__muxSelect2_net;
	electrical [0:0] tmpSIOVREF__muxSelect2_net;
	...
	cy_psoc3_pins_v1_10
		...
		muxSelect2
		 (.oe(tmpOE__muxSelect2_net),
		  .y({1'b0}),
		  .fb({Net_199}),
		  .io({tmpIO_0__muxSelect2_net[0:0]}),
		  .siovref(tmpSIOVREF__muxSelect2_net),
		  .interrupt({tmpINTERRUPT_0__muxSelect2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__muxSelect2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__MuxSelOut_net;
	wire [0:0] tmpFB_0__MuxSelOut_net;
	wire [0:0] tmpIO_0__MuxSelOut_net;
	wire [0:0] tmpINTERRUPT_0__MuxSelOut_net;
	electrical [0:0] tmpSIOVREF__MuxSelOut_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("2f3e8ae5-cc39-4831-a5e9-a362d6b469e9"),
		  ...
		  .input_buffer_sel(2'b00))
		MuxSelOut
		 (.oe(tmpOE__MuxSelOut_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__MuxSelOut_net[0:0]}),
		  .io({tmpIO_0__MuxSelOut_net[0:0]}),
		  .siovref(tmpSIOVREF__MuxSelOut_net),
		  .interrupt({tmpINTERRUPT_0__MuxSelOut_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MuxSelOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__FSK_Out_net;
	wire [0:0] tmpFB_0__FSK_Out_net;
	wire [0:0] tmpIO_0__FSK_Out_net;
	wire [0:0] tmpINTERRUPT_0__FSK_Out_net;
	electrical [0:0] tmpSIOVREF__FSK_Out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		FSK_Out
		 (.oe(tmpOE__FSK_Out_net),
		  .y({Net_195}),
		  .fb({tmpFB_0__FSK_Out_net[0:0]}),
		  .io({tmpIO_0__FSK_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__FSK_Out_net),
		  .interrupt({tmpINTERRUPT_0__FSK_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__FSK_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
