...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ef706f48-2e37-4808-afec-dcdde6c097b4/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=11, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=22, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_2, CY_INSTANCE_SHORT_NAME=PWM_2, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=PWM_2, )
module PWM_v3_30_5 (
    reset,
    clock,
    tc,
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=13, CompareValue2=255, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=27, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_3, CY_INSTANCE_SHORT_NAME=PWM_3, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=PWM_3, )
module PWM_v3_30_6 (
    reset,
    clock,
    tc,
...
module top ;
	...
	cy_clock_v1_0
		#(.id("8e4c868e-7a04-4266-b6b6-7fabfbf90d50"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
    ...
    Timer_v2_70_3 PWM_Switch_Timer (
        .reset(Net_16),
        .interrupt(Net_126),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_145),
        .clock(Net_14));
    defparam PWM_Switch_Timer.CaptureCount = 2;
    defparam PWM_Switch_Timer.CaptureCounterEnabled = 0;
    defparam PWM_Switch_Timer.DeviceFamily = "PSoC5";
    defparam PWM_Switch_Timer.InterruptOnCapture = 0;
    defparam PWM_Switch_Timer.InterruptOnTC = 1;
    defparam PWM_Switch_Timer.Resolution = 16;
    defparam PWM_Switch_Timer.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__HighVoltage_net;
	wire [0:0] tmpFB_0__HighVoltage_net;
	wire [0:0] tmpIO_0__HighVoltage_net;
	wire [0:0] tmpINTERRUPT_0__HighVoltage_net;
	electrical [0:0] tmpSIOVREF__HighVoltage_net;

	cy_psoc3_pins_v1_10
		#(.id("a689f7fd-9162-4ff8-9310-a9ec41d4491e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HighVoltage
		 (.oe(tmpOE__HighVoltage_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HighVoltage_net[0:0]}),
		  .io({tmpIO_0__HighVoltage_net[0:0]}),
		  .siovref(tmpSIOVREF__HighVoltage_net),
		  .interrupt({tmpINTERRUPT_0__HighVoltage_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HighVoltage_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("d381890d-5712-47ef-a992-892dfe05ac0f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("3af71fb3-2474-4ad8-8226-794c39493377"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__pin_12kHz_net;
	wire [0:0] tmpFB_0__pin_12kHz_net;
	wire [0:0] tmpIO_0__pin_12kHz_net;
	wire [0:0] tmpINTERRUPT_0__pin_12kHz_net;
	electrical [0:0] tmpSIOVREF__pin_12kHz_net;

	cy_psoc3_pins_v1_10
		#(.id("bf604c17-e529-4f66-bc2d-c4c3db97a40f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_12kHz
		 (.oe(tmpOE__pin_12kHz_net),
		  .y({Net_265}),
		  .fb({tmpFB_0__pin_12kHz_net[0:0]}),
		  .io({tmpIO_0__pin_12kHz_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_12kHz_net),
		  .interrupt({tmpINTERRUPT_0__pin_12kHz_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpFB_0__pin_36kHz_net;
	wire [0:0] tmpIO_0__pin_36kHz_net;
	wire [0:0] tmpINTERRUPT_0__pin_36kHz_net;
	electrical [0:0] tmpSIOVREF__pin_36kHz_net;

	cy_psoc3_pins_v1_10
		#(.id("d58f6a00-ba0b-421a-9172-e6370fbab00f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		pin_36kHz
		 (.oe(tmpOE__pin_36kHz_net),
		  .y({Net_295}),
		  .fb({tmpFB_0__pin_36kHz_net[0:0]}),
		  .io({tmpIO_0__pin_36kHz_net[0:0]}),
		  .siovref(tmpSIOVREF__pin_36kHz_net),
		  .interrupt({tmpINTERRUPT_0__pin_36kHz_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__pin_36kHz_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("c7eb7176-ecc6-4e2c-bce9-043bb4192a11"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__SignalBase_net;
	wire [0:0] tmpFB_0__SignalBase_net;
	wire [0:0] tmpIO_0__SignalBase_net;
	wire [0:0] tmpINTERRUPT_0__SignalBase_net;
	electrical [0:0] tmpSIOVREF__SignalBase_net;

	cy_psoc3_pins_v1_10
		#(.id("28696769-ccab-41ae-a3d3-7e3a9f49a12a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SignalBase
		 (.oe(tmpOE__SignalBase_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SignalBase_net[0:0]}),
		  .io({tmpIO_0__SignalBase_net[0:0]}),
		  .siovref(tmpSIOVREF__SignalBase_net),
		  .interrupt({tmpINTERRUPT_0__SignalBase_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SignalBase_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_70_7 checkWatchDogTimer (
        .reset(Net_12),
        .interrupt(Net_860),
        .enable(1'b1),
        .trigger(1'b1),
    ...
    defparam checkWatchDogTimer.InterruptOnTC = 1;
