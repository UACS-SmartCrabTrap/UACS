// ======================================================================
// DFT.v generated from TopDesign.cysch
// 05/14/2018 at 17:01
...
module ADC_DelSig_v3_20_0 (
	...
	cy_clock_v1_0
		#(.id("cb50e463-cb44-4fb6-8ec4-a1669276b06a/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("cb50e463-cb44-4fb6-8ec4-a1669276b06a/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module ADC_SAR_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("558058f7-2f93-482b-8bb1-94cefcc4158f/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("558058f7-2f93-482b-8bb1-94cefcc4158f/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=0, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_DELSIG, CY_INSTANCE_SHORT_NAME=VDAC8_DELSIG, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=VDAC8_DELSIG, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=0, VDAC_Speed=0, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_SAR, CY_INSTANCE_SHORT_NAME=VDAC8_SAR, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=VDAC8_SAR, )
...
module top ;
	...
	wire [0:0] tmpOE__Sar1_out_net;
	wire [0:0] tmpFB_0__Sar1_out_net;
	wire [0:0] tmpIO_0__Sar1_out_net;
	wire [0:0] tmpINTERRUPT_0__Sar1_out_net;
	electrical [0:0] tmpSIOVREF__Sar1_out_net;

	cy_psoc3_pins_v1_10
		#(.id("05b83100-301e-4a32-9519-7921d382cf7e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Sar1_out
		 (.oe(tmpOE__Sar1_out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Sar1_out_net[0:0]}),
		  .analog({Net_21}),
		  .io({tmpIO_0__Sar1_out_net[0:0]}),
		  .siovref(tmpSIOVREF__Sar1_out_net),
		  .interrupt({tmpINTERRUPT_0__Sar1_out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sar1_out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__DelSig_Out_net;
	wire [0:0] tmpFB_0__DelSig_Out_net;
	wire [0:0] tmpIO_0__DelSig_Out_net;
	wire [0:0] tmpINTERRUPT_0__DelSig_Out_net;
	electrical [0:0] tmpSIOVREF__DelSig_Out_net;

	cy_psoc3_pins_v1_10
		#(.id("81b3487d-8bff-4364-8c56-025fe1263fb2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DelSig_Out
		 (.oe(tmpOE__DelSig_Out_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DelSig_Out_net[0:0]}),
		  .analog({Net_9}),
		  .io({tmpIO_0__DelSig_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__DelSig_Out_net),
		  .interrupt({tmpINTERRUPT_0__DelSig_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DelSig_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    VDAC8_v1_90_2 VDAC8_DELSIG (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_9));
    defparam VDAC8_DELSIG.Data_Source = 0;
    defparam VDAC8_DELSIG.Initial_Value = 100;
    defparam VDAC8_DELSIG.Strobe_Mode = 0;

    VDAC8_v1_90_3 VDAC8_SAR (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_21));
    defparam VDAC8_SAR.Data_Source = 0;
    defparam VDAC8_SAR.Initial_Value = 100;
    defparam VDAC8_SAR.Strobe_Mode = 0;
	...
	wire [0:0] tmpOE__SAR_Input_net;
	wire [0:0] tmpFB_0__SAR_Input_net;
	wire [0:0] tmpIO_0__SAR_Input_net;
	wire [0:0] tmpINTERRUPT_0__SAR_Input_net;
	electrical [0:0] tmpSIOVREF__SAR_Input_net;

	cy_psoc3_pins_v1_10
		#(.id("1470a871-fe6f-49b1-a8bc-f150820c9f36"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SAR_Input
		 (.oe(tmpOE__SAR_Input_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SAR_Input_net[0:0]}),
		  .analog({Net_35}),
		  .io({tmpIO_0__SAR_Input_net[0:0]}),
		  .siovref(tmpSIOVREF__SAR_Input_net),
		  .interrupt({tmpINTERRUPT_0__SAR_Input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SAR_Input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
