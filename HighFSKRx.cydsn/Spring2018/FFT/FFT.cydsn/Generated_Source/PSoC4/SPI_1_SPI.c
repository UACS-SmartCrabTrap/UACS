...
void SPI_1_SpiPostEnable(void)
{
    ...
    if (SPI_1_CHECK_SPI_MASTER)
    {
        ...
        SPI_1_SET_HSIOM_SEL(SPI_1_SCLK_HSIOM_REG, SPI_1_SCLK_HSIOM_MASK,
                                       SPI_1_SCLK_HSIOM_POS, SPI_1_SCLK_HSIOM_SEL_SPI);
    #endif /* (SPI_1_SCLK_PIN) */

    #if (SPI_1_SS0_PIN)
        /* Set SCB SPI to drive output pin */
        SPI_1_SET_HSIOM_SEL(SPI_1_SS0_HSIOM_REG, SPI_1_SS0_HSIOM_MASK,
                                       SPI_1_SS0_HSIOM_POS, SPI_1_SS0_HSIOM_SEL_SPI);
    #endif /* (SPI_1_SS0_PIN) */
...
void SPI_1_SpiStop(void)
{
    ...
    if (SPI_1_CHECK_SPI_MASTER)
    {
        ...
        SPI_1_SET_HSIOM_SEL(SPI_1_SCLK_HSIOM_REG, SPI_1_SCLK_HSIOM_MASK,
                                       SPI_1_SCLK_HSIOM_POS, SPI_1_SCLK_HSIOM_SEL_GPIO);
    #endif /* (SPI_1_spi_sclk_PIN) */
        ...
        /* Set GPIO to drive output pin */
        SPI_1_SET_HSIOM_SEL(SPI_1_SS0_HSIOM_REG, SPI_1_SS0_HSIOM_MASK,
                                       SPI_1_SS0_HSIOM_POS, SPI_1_SS0_HSIOM_SEL_GPIO);
    #endif /* (SPI_1_spi_ss0_PIN) */
