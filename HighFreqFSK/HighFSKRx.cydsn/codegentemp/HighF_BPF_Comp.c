...
uint8 HighF_BPF_Comp_initVar = 0u;

/* Internal functions definitoin */
static void HighF_BPF_Comp_trimAdjust(uint8 nibble) ;

/* static HighF_BPF_Comp_backupStruct  HighF_BPF_Comp_backup; */
#if (CY_PSOC5A)
    static HighF_BPF_Comp_LOWPOWER_BACKUP_STRUCT  HighF_BPF_Comp_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 HighF_BPF_Comp_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: HighF_BPF_Comp_Init
********************************************************************************
*
* Summary:
...
void HighF_BPF_Comp_Init(void) 
{
    ...
    HighF_BPF_Comp_SetSpeed(HighF_BPF_Comp_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( HighF_BPF_Comp_DEFAULT_HYSTERESIS == 0u )
        HighF_BPF_Comp_CR |= HighF_BPF_Comp_HYST_OFF;
    #else
        HighF_BPF_Comp_CR &= (uint8)(~HighF_BPF_Comp_HYST_OFF);
    #endif /* HighF_BPF_Comp_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( HighF_BPF_Comp_DEFAULT_PWRDWN_OVRD == 0u )
            HighF_BPF_Comp_CR &= (uint8)(~HighF_BPF_Comp_PWRDWN_OVRD);
        #else 
            HighF_BPF_Comp_CR |= HighF_BPF_Comp_PWRDWN_OVRD;
        #endif /* HighF_BPF_Comp_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    HighF_BPF_Comp_CR |= HighF_BPF_Comp_MX_AO;

    /* Set default sync */
    HighF_BPF_Comp_CLK &= (uint8)(~HighF_BPF_Comp_SYNCCLK_MASK);
    #if ( HighF_BPF_Comp_DEFAULT_BYPASS_SYNC == 0u )
        HighF_BPF_Comp_CLK |= HighF_BPF_Comp_SYNC_CLK_EN;
    #else
        HighF_BPF_Comp_CLK |= HighF_BPF_Comp_BYPASS_SYNC;
    #endif /* HighF_BPF_Comp_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: HighF_BPF_Comp_Enable
********************************************************************************
*
* Summary:
...
{
    HighF_BPF_Comp_PWRMGR |= HighF_BPF_Comp_ACT_PWR_EN;
    HighF_BPF_Comp_STBY_PWRMGR |= HighF_BPF_Comp_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(HighF_BPF_Comp_restoreReg == 1u)
        {
            HighF_BPF_Comp_CR = HighF_BPF_Comp_lowPowerBackup.compCRReg;

            /* Clear the flag */
            HighF_BPF_Comp_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: HighF_BPF_Comp_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  HighF_BPF_Comp_initVar: Is modified when this function is called for the 
...
void HighF_BPF_Comp_Start(void) 
{
    ...
    if ( HighF_BPF_Comp_initVar == 0u )
    {
        HighF_BPF_Comp_Init();
        
        HighF_BPF_Comp_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: HighF_BPF_Comp_Stop
********************************************************************************
*
* Summary:
...
void HighF_BPF_Comp_Stop(void) 
{
    ...
    HighF_BPF_Comp_PWRMGR &= (uint8)(~HighF_BPF_Comp_ACT_PWR_EN);
    HighF_BPF_Comp_STBY_PWRMGR &= (uint8)(~HighF_BPF_Comp_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        HighF_BPF_Comp_restoreReg = 1u;

        /* Save the control register before clearing it */
        HighF_BPF_Comp_lowPowerBackup.compCRReg = HighF_BPF_Comp_CR;
        HighF_BPF_Comp_CR = HighF_BPF_Comp_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: HighF_BPF_Comp_SetSpeed
********************************************************************************
*
* Summary:
...
void HighF_BPF_Comp_SetSpeed(uint8 speed) 
{
    ...
    HighF_BPF_Comp_CR = (HighF_BPF_Comp_CR & (uint8)(~HighF_BPF_Comp_PWR_MODE_MASK)) |
                           (speed & HighF_BPF_Comp_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == HighF_BPF_Comp_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            HighF_BPF_Comp_TR = HighF_BPF_Comp_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            HighF_BPF_Comp_TR0 = HighF_BPF_Comp_HS_TRIM_TR0;
            HighF_BPF_Comp_TR1 = HighF_BPF_Comp_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            HighF_BPF_Comp_TR = HighF_BPF_Comp_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            HighF_BPF_Comp_TR0 = HighF_BPF_Comp_LS_TRIM_TR0;
            HighF_BPF_Comp_TR1 = HighF_BPF_Comp_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: HighF_BPF_Comp_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( HighF_BPF_Comp_WRK & HighF_BPF_Comp_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: HighF_BPF_Comp_trimAdjust
********************************************************************************
*
* Summary:
...
static void HighF_BPF_Comp_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = HighF_BPF_Comp_WRK & HighF_BPF_Comp_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                HighF_BPF_Comp_TR |= HighF_BPF_Comp_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                HighF_BPF_Comp_TR0 |= HighF_BPF_Comp_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                HighF_BPF_Comp_TR |= HighF_BPF_Comp_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                HighF_BPF_Comp_TR1 |= HighF_BPF_Comp_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                HighF_BPF_Comp_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                HighF_BPF_Comp_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                HighF_BPF_Comp_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                HighF_BPF_Comp_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((HighF_BPF_Comp_WRK & HighF_BPF_Comp_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: HighF_BPF_Comp_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 HighF_BPF_Comp_ZeroCal(void) 
{
    ...
    tmpSW0 = HighF_BPF_Comp_SW0;
    tmpSW2 = HighF_BPF_Comp_SW2;
    tmpSW3 = HighF_BPF_Comp_SW3;

     /* Clear routing for inP, retain routing for inN */
    HighF_BPF_Comp_SW0 = 0x00u;
    HighF_BPF_Comp_SW2 = 0x00u;
    HighF_BPF_Comp_SW3 = tmpSW3 & (uint8)(~HighF_BPF_Comp_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = HighF_BPF_Comp_CR;
    HighF_BPF_Comp_CR |= (HighF_BPF_Comp_CAL_ON | HighF_BPF_Comp_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        HighF_BPF_Comp_TR = HighF_BPF_Comp_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        HighF_BPF_Comp_TR0 = HighF_BPF_Comp_DEFAULT_CMP_TRIM;
        HighF_BPF_Comp_TR1 = HighF_BPF_Comp_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (HighF_BPF_Comp_CR & HighF_BPF_Comp_PWR_MODE_MASK) == HighF_BPF_Comp_PWR_MODE_FAST)
    {
        HighF_BPF_Comp_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        HighF_BPF_Comp_trimAdjust(1u);
		HighF_BPF_Comp_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    HighF_BPF_Comp_CR = tmpCR;
    
    /* Restore routing registers for inP */
    HighF_BPF_Comp_SW0 = tmpSW0;
    HighF_BPF_Comp_SW2 = tmpSW2;
    HighF_BPF_Comp_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) HighF_BPF_Comp_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)HighF_BPF_Comp_TR1 << 8u) | (HighF_BPF_Comp_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: HighF_BPF_Comp_LoadTrim
********************************************************************************
*
* Summary:
...
void HighF_BPF_Comp_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: HighF_BPF_Comp_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: HighF_BPF_Comp_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
