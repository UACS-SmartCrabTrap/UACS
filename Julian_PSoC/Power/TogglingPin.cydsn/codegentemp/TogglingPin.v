// ======================================================================
// TogglingPin.v generated from TopDesign.cysch
// 05/28/2018 at 22:23
...
module top ;
	...
	wire [0:0] tmpOE__Toggle_Pin_net;
	wire [0:0] tmpFB_0__Toggle_Pin_net;
	wire [0:0] tmpIO_0__Toggle_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Toggle_Pin_net;
	electrical [0:0] tmpSIOVREF__Toggle_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		Toggle_Pin
		 (.oe(tmpOE__Toggle_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Toggle_Pin_net[0:0]}),
		  .io({tmpIO_0__Toggle_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Toggle_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Toggle_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Toggle_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    PWM_v3_30_1 PWM_40k (
        ...
        .ph1(Net_30),
        .ph2(Net_31));
    defparam PWM_40k.Resolution = 8;


	cy_clock_v1_0
		#(.id("d9d56648-eaaa-460e-948f-344c71a1f36a"),
	...
	wire [0:0] tmpOE__Pin_40k_net;
	wire [0:0] tmpFB_0__Pin_40k_net;
	wire [0:0] tmpIO_0__Pin_40k_net;
	wire [0:0] tmpINTERRUPT_0__Pin_40k_net;
	electrical [0:0] tmpSIOVREF__Pin_40k_net;

	cy_psoc3_pins_v1_10
		#(.id("b92bcd10-1a39-4ffd-9007-e41d6465b8c2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_40k
		 (.oe(tmpOE__Pin_40k_net),
		  .y({Net_29}),
		  .fb({tmpFB_0__Pin_40k_net[0:0]}),
		  .io({tmpIO_0__Pin_40k_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_40k_net),
		  .interrupt({tmpINTERRUPT_0__Pin_40k_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_40k_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
