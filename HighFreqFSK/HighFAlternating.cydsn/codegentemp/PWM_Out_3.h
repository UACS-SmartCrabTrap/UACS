...
void    PWM_Out_3_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the PWM_Out_3_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(PWM_Out_3__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in PWM_Out_3_SetInterruptMode() function.
     *  @{
     */
        #define PWM_Out_3_INTR_NONE      (uint16)(0x0000u)
        #define PWM_Out_3_INTR_RISING    (uint16)(0x0001u)
        #define PWM_Out_3_INTR_FALLING   (uint16)(0x0002u)
        #define PWM_Out_3_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define PWM_Out_3_INTR_MASK      (0x01u) 
#endif /* (PWM_Out_3__INTSTAT) */
...
/* SIO registers */
#if defined(PWM_Out_3__SIO_CFG)
    #define PWM_Out_3_SIO_HYST_EN        (* (reg8 *) PWM_Out_3__SIO_HYST_EN)
    #define PWM_Out_3_SIO_REG_HIFREQ     (* (reg8 *) PWM_Out_3__SIO_REG_HIFREQ)
    #define PWM_Out_3_SIO_CFG            (* (reg8 *) PWM_Out_3__SIO_CFG)
    #define PWM_Out_3_SIO_DIFF           (* (reg8 *) PWM_Out_3__SIO_DIFF)
#endif /* (PWM_Out_3__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define PWM_Out_3_0_INTTYPE_REG 		(* (reg8 *) PWM_Out_3__0__INTTYPE)
#endif /* (PWM_Out_3__INTSTAT) */
