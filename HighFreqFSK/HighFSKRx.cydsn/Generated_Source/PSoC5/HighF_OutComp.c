...
uint8 HighF_OutComp_initVar = 0u;

/* Internal functions definitoin */
static void HighF_OutComp_trimAdjust(uint8 nibble) ;

/* static HighF_OutComp_backupStruct  HighF_OutComp_backup; */
#if (CY_PSOC5A)
    static HighF_OutComp_LOWPOWER_BACKUP_STRUCT  HighF_OutComp_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 HighF_OutComp_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: HighF_OutComp_Init
********************************************************************************
*
* Summary:
...
void HighF_OutComp_Init(void) 
{
    ...
    HighF_OutComp_SetSpeed(HighF_OutComp_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( HighF_OutComp_DEFAULT_HYSTERESIS == 0u )
        HighF_OutComp_CR |= HighF_OutComp_HYST_OFF;
    #else
        HighF_OutComp_CR &= (uint8)(~HighF_OutComp_HYST_OFF);
    #endif /* HighF_OutComp_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( HighF_OutComp_DEFAULT_PWRDWN_OVRD == 0u )
            HighF_OutComp_CR &= (uint8)(~HighF_OutComp_PWRDWN_OVRD);
        #else 
            HighF_OutComp_CR |= HighF_OutComp_PWRDWN_OVRD;
        #endif /* HighF_OutComp_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    HighF_OutComp_CR |= HighF_OutComp_MX_AO;

    /* Set default sync */
    HighF_OutComp_CLK &= (uint8)(~HighF_OutComp_SYNCCLK_MASK);
    #if ( HighF_OutComp_DEFAULT_BYPASS_SYNC == 0u )
        HighF_OutComp_CLK |= HighF_OutComp_SYNC_CLK_EN;
    #else
        HighF_OutComp_CLK |= HighF_OutComp_BYPASS_SYNC;
    #endif /* HighF_OutComp_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: HighF_OutComp_Enable
********************************************************************************
*
* Summary:
...
{
    HighF_OutComp_PWRMGR |= HighF_OutComp_ACT_PWR_EN;
    HighF_OutComp_STBY_PWRMGR |= HighF_OutComp_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(HighF_OutComp_restoreReg == 1u)
        {
            HighF_OutComp_CR = HighF_OutComp_lowPowerBackup.compCRReg;

            /* Clear the flag */
            HighF_OutComp_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: HighF_OutComp_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  HighF_OutComp_initVar: Is modified when this function is called for the 
...
void HighF_OutComp_Start(void) 
{
    ...
    if ( HighF_OutComp_initVar == 0u )
    {
        HighF_OutComp_Init();
        
        HighF_OutComp_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: HighF_OutComp_Stop
********************************************************************************
*
* Summary:
...
void HighF_OutComp_Stop(void) 
{
    ...
    HighF_OutComp_PWRMGR &= (uint8)(~HighF_OutComp_ACT_PWR_EN);
    HighF_OutComp_STBY_PWRMGR &= (uint8)(~HighF_OutComp_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        HighF_OutComp_restoreReg = 1u;

        /* Save the control register before clearing it */
        HighF_OutComp_lowPowerBackup.compCRReg = HighF_OutComp_CR;
        HighF_OutComp_CR = HighF_OutComp_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: HighF_OutComp_SetSpeed
********************************************************************************
*
* Summary:
...
void HighF_OutComp_SetSpeed(uint8 speed) 
{
    ...
    HighF_OutComp_CR = (HighF_OutComp_CR & (uint8)(~HighF_OutComp_PWR_MODE_MASK)) |
                           (speed & HighF_OutComp_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == HighF_OutComp_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            HighF_OutComp_TR = HighF_OutComp_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            HighF_OutComp_TR0 = HighF_OutComp_HS_TRIM_TR0;
            HighF_OutComp_TR1 = HighF_OutComp_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            HighF_OutComp_TR = HighF_OutComp_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            HighF_OutComp_TR0 = HighF_OutComp_LS_TRIM_TR0;
            HighF_OutComp_TR1 = HighF_OutComp_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: HighF_OutComp_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( HighF_OutComp_WRK & HighF_OutComp_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: HighF_OutComp_trimAdjust
********************************************************************************
*
* Summary:
...
static void HighF_OutComp_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = HighF_OutComp_WRK & HighF_OutComp_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                HighF_OutComp_TR |= HighF_OutComp_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                HighF_OutComp_TR0 |= HighF_OutComp_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                HighF_OutComp_TR |= HighF_OutComp_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                HighF_OutComp_TR1 |= HighF_OutComp_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        ...
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                HighF_OutComp_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                HighF_OutComp_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((HighF_OutComp_WRK & HighF_OutComp_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: HighF_OutComp_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 HighF_OutComp_ZeroCal(void) 
{
    ...
    tmpSW0 = HighF_OutComp_SW0;
    tmpSW2 = HighF_OutComp_SW2;
    tmpSW3 = HighF_OutComp_SW3;

     /* Clear routing for inP, retain routing for inN */
    HighF_OutComp_SW0 = 0x00u;
    HighF_OutComp_SW2 = 0x00u;
    HighF_OutComp_SW3 = tmpSW3 & (uint8)(~HighF_OutComp_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = HighF_OutComp_CR;
    HighF_OutComp_CR |= (HighF_OutComp_CAL_ON | HighF_OutComp_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        HighF_OutComp_TR = HighF_OutComp_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        HighF_OutComp_TR0 = HighF_OutComp_DEFAULT_CMP_TRIM;
        HighF_OutComp_TR1 = HighF_OutComp_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (HighF_OutComp_CR & HighF_OutComp_PWR_MODE_MASK) == HighF_OutComp_PWR_MODE_FAST)
    {
        HighF_OutComp_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        HighF_OutComp_trimAdjust(1u);
		HighF_OutComp_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    HighF_OutComp_CR = tmpCR;
    
    /* Restore routing registers for inP */
    HighF_OutComp_SW0 = tmpSW0;
    HighF_OutComp_SW2 = tmpSW2;
    HighF_OutComp_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) HighF_OutComp_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)HighF_OutComp_TR1 << 8u) | (HighF_OutComp_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: HighF_OutComp_LoadTrim
********************************************************************************
*
* Summary:
...
void HighF_OutComp_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: HighF_OutComp_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: HighF_OutComp_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
