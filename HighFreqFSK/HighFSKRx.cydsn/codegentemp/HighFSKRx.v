...
module top ;
    ...
    Timer_v2_70_4 HighF_LevelCount (
        .reset(Net_124),
        .interrupt(Net_109),
        .enable(1'b1),
        .trigger(1'b1),
