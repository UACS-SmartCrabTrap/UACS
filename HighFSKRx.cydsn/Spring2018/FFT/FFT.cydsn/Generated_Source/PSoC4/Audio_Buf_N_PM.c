...
#if(!Audio_Buf_N_CHECK_DEEPSLEEP_SUPPORT)
    static Audio_Buf_N_BACKUP_STRUCT Audio_Buf_N_backup =
    {
        0u, /* enableState */
    };
#endif /* (Audio_Buf_N_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: Audio_Buf_N_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Audio_Buf_N_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
/*******************************************************************************
* Function Name: Audio_Buf_N_Sleep
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Audio_Buf_N_backup: The structure field 'enableState' is modified
...
{
#if(!Audio_Buf_N_CHECK_DEEPSLEEP_SUPPORT)
    if(Audio_Buf_N_CHECK_PWR_MODE_OFF)
    {
        Audio_Buf_N_backup.enableState = 1u;
        Audio_Buf_N_Stop();
    }
    else /* The component is disabled */
    {
        Audio_Buf_N_backup.enableState = 0u;
    }
#endif /* (Audio_Buf_N_CHECK_DEEPSLEEP_SUPPORT) */
}
...
/*******************************************************************************
* Function Name: Audio_Buf_N_Wakeup
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  Audio_Buf_N_backup: The structure field 'enableState' is used to
...
{
#if(!Audio_Buf_N_CHECK_DEEPSLEEP_SUPPORT)
    if(0u != Audio_Buf_N_backup.enableState)
    {
