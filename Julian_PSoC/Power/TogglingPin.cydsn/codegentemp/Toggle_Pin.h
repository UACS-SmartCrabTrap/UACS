...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the Toggle_Pin_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(Toggle_Pin__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in Toggle_Pin_SetInterruptMode() function.
     *  @{
     */
        #define Toggle_Pin_INTR_NONE      (uint16)(0x0000u)
        #define Toggle_Pin_INTR_RISING    (uint16)(0x0001u)
        #define Toggle_Pin_INTR_FALLING   (uint16)(0x0002u)
        #define Toggle_Pin_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define Toggle_Pin_INTR_MASK      (0x01u) 
#endif /* (Toggle_Pin__INTSTAT) */
...
/* SIO registers */
#if defined(Toggle_Pin__SIO_CFG)
    #define Toggle_Pin_SIO_HYST_EN        (* (reg8 *) Toggle_Pin__SIO_HYST_EN)
    #define Toggle_Pin_SIO_REG_HIFREQ     (* (reg8 *) Toggle_Pin__SIO_REG_HIFREQ)
    #define Toggle_Pin_SIO_CFG            (* (reg8 *) Toggle_Pin__SIO_CFG)
    #define Toggle_Pin_SIO_DIFF           (* (reg8 *) Toggle_Pin__SIO_DIFF)
#endif /* (Toggle_Pin__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define Toggle_Pin_0_INTTYPE_REG 		(* (reg8 *) Toggle_Pin__0__INTTYPE)
#endif /* (Toggle_Pin__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_Toggle_Pin_H */
