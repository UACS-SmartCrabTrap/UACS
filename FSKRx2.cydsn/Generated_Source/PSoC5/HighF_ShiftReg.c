...
{
    CY_SET_REG24(HighF_ShiftReg_SHIFT_REG_LSB_PTR, shiftData);
}
    ...
    *******************************************************************************/
                                                                         ...
                                                                         
    {
        ...
        {
            CY_SET_REG24(HighF_ShiftReg_IN_FIFO_VAL_LSB_PTR, shiftData);
    ...
    *******************************************************************************/
    ...
    {
        return(CY_GET_REG24(HighF_ShiftReg_OUT_FIFO_VAL_LSB_PTR));
    }
...
uint32 HighF_ShiftReg_ReadRegValue(void) 
{
    ...
    {
        (void) CY_GET_REG24(HighF_ShiftReg_OUT_FIFO_VAL_LSB_PTR);
    }
    ...
    /* Read output FIFO */
    result  = CY_GET_REG24(HighF_ShiftReg_OUT_FIFO_VAL_LSB_PTR);
