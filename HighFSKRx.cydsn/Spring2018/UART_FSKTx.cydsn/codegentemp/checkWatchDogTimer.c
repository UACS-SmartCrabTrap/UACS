...
{
   #if(checkWatchDogTimer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(checkWatchDogTimer_PERIOD_LSB_PTR));
   #else
       return (CY_GET_REG16(checkWatchDogTimer_PERIOD_LSB_PTR));
   #endif /* (checkWatchDogTimer_UsingFixedFunction) */
}
...
void checkWatchDogTimer_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(checkWatchDogTimer_PERIOD_LSB_PTR, period);
...
{
   #if(checkWatchDogTimer_UsingFixedFunction)
       return ((uint16)CY_GET_REG16(checkWatchDogTimer_CAPTURE_LSB_PTR));
   #else
       return (CY_GET_REG16(checkWatchDogTimer_CAPTURE_LSB_PTR));
   #endif /* (checkWatchDogTimer_UsingFixedFunction) */
}
...
void checkWatchDogTimer_WriteCounter(uint16 counter) 
{
    ...
    #else
        CY_SET_REG16(checkWatchDogTimer_COUNTER_LSB_PTR, counter);
